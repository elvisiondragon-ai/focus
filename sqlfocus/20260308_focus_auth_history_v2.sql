...
BEGIN
    ...
    ON CONFLICT (user_id) DO UPDATE SET
        ...
        display_name = COALESCE(EXCLUDED.display_name, focus_clients.display_name);
    RETURN NEW;
END;
